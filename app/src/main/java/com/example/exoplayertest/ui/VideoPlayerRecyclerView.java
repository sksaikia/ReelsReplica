...
public class VideoPlayerRecyclerView extends RecyclerView {
    ...
    // vars
    private ArrayList<MainResponseBody> mediaObjects = new ArrayList<>();
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        if (child == null) {
            Log.d(TAG, "playVideo: child is null");
            return;
        }

        VideoPlayerViewHolder holder = (VideoPlayerViewHolder) child.getTag();
        if (holder == null) {
            Log.d(TAG, "playVideo: holder is null");
            playPosition = -1;
            return;
        }
...
//                        .into(volumeControl);
    ...
    public void setMediaObjects(ArrayList<MainResponseBody> mediaObjects){
